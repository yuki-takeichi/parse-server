...
describe('ParsePushAdapter', () => {
  ...
  it('can register push senders', (done) => {
    var parsePushAdapter = new ParsePushAdapter();
    // Make mock config
    var pushConfig = {
      android: {
    ...
    parsePushAdapter.registerPushSenders(pushConfig);
    // Check ios
  ...
  it('can throw on registering with unsupported push type', (done) => {
    var parsePushAdapter = new ParsePushAdapter();
    // Make mock config
    var pushConfig = {
      win: {
  ...
  it('can throw on registering with invalid pushConfig', (done) => {
    var parsePushAdapter = new ParsePushAdapter();
    // Make mock config
    var pushConfig = {
      android: 123
